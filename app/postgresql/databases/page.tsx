...
import { getPostgresqlDatabases, savePostgresqlDatabases } from "@/lib/storage"
...
export default function PostgresDatabases() {
  ...
  useEffect(() => {
    ...
    if (storedDatabases.length > 0) {
      ...
      const initialDatabases = [
        { id: "1", name: "customers_db", created_at: "2023-05-15T10:30:00Z" },
        { id: "2", name: "inventory_db", created_at: "2023-06-22T14:45:00Z" },
        { id: "3", name: "analytics_db", created_at: "2023-07-10T09:15:00Z" },
      ]
      setDatabases(initialDatabases)
      savePostgresqlDatabases(initialDatabases)
    }
  }, [])
  ...
  const handleCreateDatabase = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      savePostgresqlDatabases(updatedDatabases) // Save to localStorage
        ...
        <div className="container flex h-16 items-center px-4">
          <div className="flex gap-6 md:gap-10">
            ...
            <nav className="flex gap-6">
              <Link href="/postgresql/databases" className="flex items-center text-sm font-medium text-primary">
                PostgreSQL
              </Link>
              <Link
                href="/postgresql/query-editor"
        ...
        <section className="container grid items-center gap-6 pb-8 pt-6 md:py-10">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg text-muted-foreground mt-2">Manage your PostgreSQL databases</p>
            </div>
            <Dialog open={open} onOpenChange={setOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Enter a name for your new PostgreSQL database.</DialogDescription>
                </DialogHeader>
              ...
              <Card key={db.id}>
                ...
                <CardContent>
                  ...
                  <div className="mt-4 flex justify-end">
                    <Link href={`/postgresql/databases/${db.id}/tables`}>
